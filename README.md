...
A cleaner version is live at [writings.cafeine.dev](https://writings.cafeine.dev). See the
[Makefile](Makefile) for how it's built, and [zola/README.md](zola/README.md) for the
technical notes (deployment, caching, and the architecture of the site engine).
